...
public class  JdbcUserDAO implements UserDAO {
    ...
    @Override
    public List<User> findAllExceptCurrentUser(int id) {
        List<User> users = new ArrayList<>();
    ...
    @Override
    public String findUserNameByAccount(int userId) {
        String sql = "SELECT users.username FROM users JOIN accounts ON users.user_id = accounts.user_id " +
                "WHERE account_id = ?";
        String usernameFromSql= jdbcTemplate.queryForObject(sql, String.class, userId);
